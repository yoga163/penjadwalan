                    ...
                    <div class="modal-body">
                        <form id="form_add">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukkan Kode Waktu" id="data_kode_add" name="kode"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukkan Waktu" name="range_Waktu_selesai"
...
<script>
    $(document).ready(function(){
		$('.dataTable').DataTable( {
			ajax: {
				url: "<?php echo base_url('jadwal/data_waktu/view_all/')?>",
				type: 'POST',
			},
			columnDefs: [
			{   targets: 0, 
    ...
    function do_add(){
        if($("#form_add")[0].checkValidity()) {
            $.ajax({
				url: "<?php echo base_url('jadwal/add_data_waktu')?>",
				type: 'POST',
    ...
    function do_edit(){
        if($("#form_edit")[0].checkValidity()) {
            $.ajax({
				url: "<?php echo base_url('jadwal/edit_data_waktu')?>",
				type: 'POST',
    ...
    function do_delete(id){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo base_url('jadwal/delete_data_waktu')?>",
                    type: 'POST',
                    data: {id:id},
                    dataType: "json",
                    success: function(data){
    ...
    function do_view(id){
        $('#view').modal('show')
        $.ajax({
            url: "<?php echo base_url('jadwal/data_waktu/view_one')?>",
            type: 'POST',
            data: {id:id},
            dataType: "json",
            success: function(data){
